...
const AdminDashboard = () => {
  ...
  return (
    <Layout title={"Admin Dashboard - CodySpot"}>
      <div className="container-fluid p-3">
        <div className="row">
          ...
          <div className="col-md-9">
            <h6 className="small-heading filters-bg mt-3">Admin Dashboard</h6>

            <h5 className=" mt-5 heading text-blue ms-3 mb-0">ADMIN INFO</h5>
            <div
